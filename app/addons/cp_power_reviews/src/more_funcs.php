...
function fn_cp_pr_create_seo_settings($is_upgrade = false)
{
    ...
    if (!empty($seo_active)) {
        ...
        foreach ($all_comp as $company) {
            fn_cp_pr_create_reviews_page_seo_data($company);
...
//                 }
    ...
    */
    ...
    if (empty($tag_setting_id)) {
        ...
        $tag_variants = array(
            'cp_pr_review' => '/reviews/object.html',
            'cp_pr_review_nohtml' => '/reviews/object/',
        );

        fn_cp_pr_update_third_party_addon_settings_variants($tag_setting_id, $review_setting_name, $tag_variants, 'seo');
        
        
        $review_setting_name_ = 'seo_cp_pr_reviews_page';
        $tag_setting_id_ = Settings::instance()->update(array(
            'name' =>           $review_setting_name_,
            'section_id' =>     $seo_section_id,
            'section_tab_id' => $seo_tab_id,
            'type' =>           'S',
            'position' =>       1152,
        ...
        Settings::instance()->updateValueById($tag_setting_id_, 'cp_pr_reviews_nohtml', null, false);

        $tag_setting_translations_ = array();
        ...
        fn_update_addon_settings_descriptions($tag_setting_id_, Settings::SETTING_DESCRIPTION, $tag_setting_translations_);
        fn_update_addon_settings_originals('seo', $tag_setting_id_, 'option', 'All reviews page SEO URL format');
        ...
        fn_cp_pr_update_third_party_addon_settings_variants($tag_setting_id_, $review_setting_name_, $tag_variants_, 'seo');
