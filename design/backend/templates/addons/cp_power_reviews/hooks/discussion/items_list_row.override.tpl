{if in_array($discussion.object_type,array("P","E","M","C","A","B"))}
    {$allow_title=false}
    ...
    {elseif $discussion.object_type == "A" || $discussion.object_type == "B"}
        ...
        {/if}
    {/if}
    {include file="addons/cp_power_reviews/components/post.tpl" post=$post type=$discussion.type show_title=$allow_title show_adv=$allow_adv_disadv}
