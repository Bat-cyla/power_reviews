...
<div class="cp-pr__dnd_uploader file-uploader cm-file-uploader"
    data-ca-upload-url="{"cp_pow_rev.upload"|fn_url}"
            ...
            <div class="file-uploader__file-square {if !$existing_files}file-uploader__file-square--no-files{/if}">
                <div class="file-uploader__pickers-content">
                    ...
                    <div class="btn-group file-uploader__pickers-buttons" id="last_edited_items" data-ca-fileupload-picker-container>
                        <a class="ty-btn file-uploader__pickers-buttons-select" data-ca-fileupload-picker-local>
                            {__("upload")}
                        </a>
                        {if $breadcrumbs|sizeof >= 1}
                            <ul class="" data-ca-fileupload-picker-menu>
                                <li><a class="ty-btn" data-ca-fileupload-picker-url>{__("url")}</a></li>
                            </ul>
                        {/if}
        ...
        <div class="file-uploader__file-square">
            ...
            <div class="cm-hide-with-inputs">
                <div class="file-uploader__remove-overlay hidden">
                    <div class="file-uploader__remove-text">{__("cp_pr_this_image_will_be_deleted")}</div>
                    {*
                    <div>
                ...
                <input type="hidden" name="post_data[removed_image_pair_ids][]" value="" data-ca-image-remove>
